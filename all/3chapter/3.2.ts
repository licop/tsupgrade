...
// 类型断言 as语法
let someString1: any = 'this is a string'
let strLength1: number = (someString as string).length
...
function myFunc(maybeString: string | undefined | null) {
  ...
  const onlyString: string = maybeString as string // ok
  const innoreUndefinedAndNull: string = maybeString! // ok
}
